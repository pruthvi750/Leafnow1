	  ...
	  <div class="row">
		...
		<h1 class="my-4"></h1>
			<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
			  <a class="nav-link active" id="v-pills-item-tab" data-toggle="pill" href="#v-pills-item" role="tab" aria-controls="v-pills-item" aria-selected="true">Plant</a>
			...
			<div class="tab-content" id="v-pills-tabContent">
			  <div class="tab-pane fade show active" id="v-pills-item" role="tabpanel" aria-labelledby="v-pills-item-tab">
				<div class="card card-outline-secondary my-4">
				  <div class="card-header">Plant Details</div>
				  <div class="card-body">
					<ul class="nav nav-tabs" role="tablist">
						<li class="nav-item">
							<a class="nav-link active" data-toggle="tab" href="#itemDetailsTab">Plant</a>
						</li>
						<li class="nav-item">
					...
					<div class="tab-content">
							...
							<form>
							  <div class="form-row">
								<div class="form-group col-md-3" style="display:inline-block">
								  <label for="itemDetailsItemNumber">Plant Number<span class="requiredIcon">*</span></label>
							  ...
							  <div class="form-row">
								  <div class="form-group col-md-6">
									<label for="itemDetailsItemName">Plant Name<span class="requiredIcon">*</span></label>
							  ...
							  <button type="button" id="addItem" class="btn btn-success">Add Plant</button>
						...
						<div id="itemImageTab" class="container-fluid tab-pane fade">
							...
							<form name="imageForm" id="imageForm" method="post">
							  <div class="form-row">
								<div class="form-group col-md-3" style="display:inline-block">
								  <label for="itemImageItemNumber">Plant Number<span class="requiredIcon">*</span></label>
								...
								<div class="form-group col-md-4">
									<label for="itemImageItemName">Plant Name</label>
				...
				<div class="card card-outline-secondary my-4">
				  ...
				  <div class="card-body">
					...
					<form>
					  <div class="form-row">
						<div class="form-group col-md-3">
						  <label for="purchaseDetailsItemNumber">Plant Number<span class="requiredIcon">*</span></label>
					  ...
					  <div class="form-row"> 
						  <div class="form-group col-md-4">
							<label for="purchaseDetailsItemName">Plant Name<span class="requiredIcon">*</span></label>
				...
				<div class="card card-outline-secondary my-4">
				  ...
				  <div class="card-body">
					...
					<form>
					  <div class="form-row">
						<div class="form-group col-md-3">
						  <label for="saleDetailsItemNumber">Plant Number<span class="requiredIcon">*</span></label>
					  ...
					  <div class="form-row">
						  <div class="form-group col-md-5">
							<label for="saleDetailsItemName">Plant Name</label>
			  ...
			  <div class="tab-pane fade" id="v-pills-search" role="tabpanel" aria-labelledby="v-pills-search-tab">
				<div class="card card-outline-secondary my-4">
				  ...
				  <div class="card-body">										
					<ul class="nav nav-tabs" role="tablist">
						<li class="nav-item">
							<a class="nav-link active" data-toggle="tab" href="#itemSearchTab">Plant</a>
						</li>
						<li class="nav-item">
					...
					<div class="tab-content">
						<div id="itemSearchTab" class="container-fluid tab-pane active">
						  <br>
						  <p>Use the grid below to search all details of Plants</p>
			  ...
			  <div class="tab-pane fade" id="v-pills-reports" role="tabpanel" aria-labelledby="v-pills-reports-tab">
				<div class="card card-outline-secondary my-4">
				  ...
				  <div class="card-body">										
					<ul class="nav nav-tabs" role="tablist">
						<li class="nav-item">
							<a class="nav-link active" data-toggle="tab" href="#itemReportsTab">Plant</a>
						</li>
						<li class="nav-item">
